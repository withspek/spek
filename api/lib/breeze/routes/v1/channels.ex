defmodule Breeze.Routes.V1.Channels do
  use Plug.Router
  ...
  get "/:id/members" do
    ...
    case Ecto.UUID.cast(id) do
      {:ok, uuid} ->
        members = Channels.get_channel_members(uuid)
  ...
  post "/join" do
    ...
    if has_user_id do
      ...
      case Channels.join_channel(channel_id, user_id) do
        {:ok, channel} ->
          conn
          |> put_resp_content_type("application/json")
          |> send_resp(200, Jason.encode!(%{channel: channel}))
  ...
  post "/create" do
    ...
    if has_user_id do
      ...
      case Channels.create_channel(data, user_id) do
        {:ok, channel, _} ->
          conn
          |> put_resp_content_type("application/json")
          |> send_resp(200, Jason.encode!(%{channel: channel}))
  ...
  post "/leave" do
    ...
    if has_user_id do
      ...
      Channels.leave_channel(channel_id, user_id)
    ...
    if has_user_id do
      case Ecto.UUID.cast(id) do
        {:ok, uuid} ->
          ...
          Channels.delete_channel(uuid, user_id)
