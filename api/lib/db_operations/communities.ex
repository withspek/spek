defmodule Operations.Communities do
  ...
  defdelegate get_community_by_id_without_perms(id), to: Operations.Access.Communities
  ...
  defdelegate update_community(community_id, data), to: Operations.Mutations.Community
end
